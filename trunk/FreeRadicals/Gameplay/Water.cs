...
namespace FreeRadicals.Gameplay
{
    ...
    class Water : Actor, IBaseAgent
    {
            ...
            : base(world)
        {
            ...
            this.hydrogen1Polygon = VectorPolygon.CreateCircle(new Vector2(22f, 0), 4f, 100);
            this.hydrogen2Polygon = VectorPolygon.CreateCircle(new Vector2(0, 22f), 4f, 100);
        ...
        public override bool Touch(Actor target)
        {
            ...
            //    world.UnbondWater(newPosition, newVelocity, newDirection);
