...
namespace FreeRadicals.Gameplay.GreenhouseGases
{
    ...
    class Water : Actor
    {
            ...
            : base(world)
        {
            ...
            this.hydrogen1Polygon = VectorPolygon.CreateCircle(new Vector2(22f * world.ResVar, 0), 4f * world.ResVar, 100);
            this.hydrogen2Polygon = VectorPolygon.CreateCircle(new Vector2(0, 22f * world.ResVar), 4f * world.ResVar, 100);
