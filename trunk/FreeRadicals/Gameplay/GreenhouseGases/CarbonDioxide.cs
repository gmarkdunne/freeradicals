...
namespace FreeRadicals.Gameplay.GreenhouseGases
{
    ...
    class CarbonDioxide : Actor
    {
            ...
            : base(world)
        {
            ...
            // create the polygon
            this.oxygen1Polygon = VectorPolygon.CreateCircle(new Vector2(-30f * world.ResVar, 0), 16f * world.ResVar, 100);
            this.oxygen2Polygon = VectorPolygon.CreateCircle(new Vector2(30f * world.ResVar, 0), 16f * world.ResVar, 100);
