...
namespace FreeRadicals.Gameplay
{
    ...
    /// </summary>
    class NitrousOxide : Actor, IBaseAgent
    {
        #region Constants
            ...
            : base(world)
        {
            ...
            // create the polygon
            this.nitrogen1Polygon = VectorPolygon.CreateCircle(new Vector2(32f, 0), 14f, 100);
            this.nitrogen2Polygon = VectorPolygon.CreateCircle(new Vector2(62f, 0), 14f, 100);
        ...
        public override bool Touch(Actor target)
        {
            ...
            //    world.UnbondNitrousOxide(newPosition, newVelocity, newDirection);
