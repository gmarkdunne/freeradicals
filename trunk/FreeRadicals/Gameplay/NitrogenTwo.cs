...
{
    class NitrogenTwo : Actor, IBaseAgent
    {
        #region Constants
        ...
        public NitrogenTwo(World world)
            : base(world)
        {
            // Oxygen Radius
            ...
            this.nitrogenPolygon = VectorPolygon.CreateCircle(new Vector2(30f, 0), radius, 100);
        ...
        public override void Draw(float elapsedTime, LineBatch lineBatch)
        {
            ...
            if (nitrogenPolygon != null)
            {
                ...
                // draw the polygon
                lineBatch.DrawPolygon(nitrogenPolygon, color);
        ...
        public override bool Touch(Actor target)
        {
            ...
            //    world.UnbondNitrogenTwo(newPosition, newVelocity, newDirection);
