...
namespace FreeRadicals.Gameplay
{
    ...
    /// </summary>
    class CarbonDioxide : Actor, IBaseAgent
    {
        #region Constants
        ...
        public CarbonDioxide(World world)
            : base(world)
        {
            // Carbon Radius
            ...
            // create the polygon
            this.oxygen1Polygon = VectorPolygon.CreateCircle(new Vector2(-30f, 0), 16f, 100);
            this.oxygen2Polygon = VectorPolygon.CreateCircle(new Vector2(30f, 0), 16f, 100);
        ...
        public override void Draw(float elapsedTime, LineBatch lineBatch)
        {
            ...
            if (oxygen1Polygon != null)
            {
                ...
                // draw the polygon
                lineBatch.DrawPolygon(oxygen1Polygon, Color.Red);
            ...
            if (oxygen2Polygon != null)
            {
                ...
                // draw the polygon
                lineBatch.DrawPolygon(oxygen2Polygon, Color.Red);
        ...
        public override bool Touch(Actor target)
        {
            ...
            //    world.UnbondCarbonDioxide(newPosition, newVelocity, newDirection);
