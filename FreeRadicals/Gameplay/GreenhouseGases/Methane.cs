...
namespace FreeRadicals.Gameplay.GreenhouseGases
{
    ...
    class Methane : Actor
    {
            ...
            : base(world)
        {
            ...
            this.hydrogen3Polygon = VectorPolygon.CreateCircle(new Vector2(0, -18f * world.ResVar), 4f * world.ResVar, 100);
            this.hydrogen4Polygon = VectorPolygon.CreateCircle(new Vector2(0, 18f * world.ResVar), 4f * world.ResVar, 100);
