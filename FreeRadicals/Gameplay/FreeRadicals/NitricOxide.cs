...
namespace FreeRadicals.Gameplay.FreeRadicals
{
    ...
    class NitricOxide : Actor
    {
            ...
            : base(world)
        {
            ...
            this.nitrogenPolygon = VectorPolygon.CreateCircle(new Vector2(32f * world.ResVar, 0), 14f * world.ResVar, 100);
        ...
        public override void Update(float elapsedTime)
        {
            ...
            for (int i = 0; i < world.Actors.Count; ++i)
            {
                    ...
                    (world.Actors[i] is AtomicMoleBlastProjectile) == true)
                {
                    ...
                    if (distance.Length() <= this.collisionRadius)
                    {
                        world.Actors[i].Velocity -= -distance * 0.1f;
                    }
                }
