...
namespace FreeRadicals.Gameplay
{
    ...
    /// </summary>
    class Hydroxyl : Actor, IBaseAgent
    {
        #region Constants
            ...
            : base(world)
        {
            ...
            this.hydrogenPolygon = VectorPolygon.CreateCircle(new Vector2(22f, 0), 4f, 100);
        ...
        public override void Draw(float elapsedTime, LineBatch lineBatch)
        {
            ...
            if (hydrogenPolygon != null)
            {
                ...
                // draw the polygon
                lineBatch.DrawPolygon(hydrogenPolygon, Color.Yellow);
        ...
        public override bool Touch(Actor target)
        {
            ...
            // if the Hydrogen hit an Hydroxyl, Bond them to H2O
