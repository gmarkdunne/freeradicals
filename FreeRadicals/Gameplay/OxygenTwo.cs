...
namespace FreeRadicals.Gameplay
{
    ...
    /// </summary>
    class OxygenTwo : Actor, IBaseAgent
    {
        #region Constants
            ...
            : base(world)
        {
            ...
            this.oxygen1Polygon = VectorPolygon.CreateCircle(new Vector2(34f, 0), radius, 100);
        ...
        public override bool Touch(Actor target)
        {
            ...
            // if the oxygenTwo hit an carbon, Bond them to make CO2
            if ((target is Carbon) == true)
            {
                ...
                world.BondCarbonDioxide(newPosition, newVelocity, newDirection);
