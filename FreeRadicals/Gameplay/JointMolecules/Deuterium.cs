...
namespace FreeRadicals.Gameplay.JointMolecules
{
    /// <summary>
    /// Atoms that fill the game simulation
    /// </summary>
    class Deuterium : Actor
    {
        #region Constants
            ...
            : base(world)
        {
            ...
            this.hydrogenPolygon = VectorPolygon.CreateCircle(new Vector2(10f * world.ResVar, 0), radius, 100);
