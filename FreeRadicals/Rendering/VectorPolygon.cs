...
namespace FreeRadicals.Rendering
{
    ...
    class VectorPolygon
    {
        ...
        /// <summary>
        /// Create a polygon shaped like a Triangle.
        /// </summary>
        /// <returns>A new VectorPolygon object in the shape of a Triangle.</returns>
        public static VectorPolygon CreateTriangle()
        {
            Vector2[] points = new Vector2[3];

            points[0] = new Vector2(-20, -20);
            points[1] = new Vector2(-10, 30);
            points[2] = new Vector2(10, -30);
